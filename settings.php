...
if( !class_exists('PTIP_WordPressSettingsFramework') ){
    /**
     * WordPressSettingsFramework class
     */
    class PTIP_WordPressSettingsFramework {
         ...
         */
        function __construct( $settings, $option_group = '' )
        {
